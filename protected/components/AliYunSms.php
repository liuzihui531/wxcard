...
class AliYunSms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIgLgJ0ltlH6LC"; // AccessKeyId

        $accessKeySecret = "eRcGkbQy16UveN0L12ERI8VxhSyLwK"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($mobile, $content, $templateCode = '', $signName = '') {
...
$response = AliYunSms::sendBatchSms();
echo "批量发送短信(sendBatchSms)接口返回的结果:\n";
print_r($response);

sleep(2);

$response = AliYunSms::querySendDetails();
